...
\author[Missouri Economics Conference.  March 2007.]{James Murray}
\date{March 30, 2007}
...
\frame
{
  \ft{Model}
  \bi
  \item New Keynesian model with firm-specific capital (Woodford, 2005).
  \item Consumers exhibit internal habit formation.
  \item Calvo (1983) pricing with inflation indexation.
  \item Quadratic cost of capital adjustment.
  \item Serially correlated technology, preference, investment shocks.
  \item Expectations: constant gain learning and rational expectations.
  \ei
}
...
\frame
{
  ...
  \item Research agenda:
    \bi
    \item Let agents use an a-theoretic VAR(p) to form expectations.
    \item Dynamic (endogenously changing?) learning gain.
    \ei
  \ei
}
